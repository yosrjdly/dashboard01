...
export default function Sidebar() {
    ...
    const { primaryColor } = useThemeSettings(); // Get primary color from the theme
  
    console.log("Sidebar Rendered with Primary Color:", primaryColor); // Add this line
          ...
          {menuItems.map(({ text, icon, path }) => {
            ...
            return (
              <ListItemButton
                ...
                sx={{
                  borderRadius: 2,
                  bgcolor: isActive ? primaryColor : "transparent", // Use primaryColor for active item
                  "&:hover": { bgcolor: isActive ? primaryColor : "rgba(255, 255, 255, 0.1)" },
