...
export default function Sidebar() {
  ...
  return (
    <Drawer variant="permanent" sx={{ width: 350, bgcolor: "background.paper" }}>
  ...
  selected={!isActive}
  sx={{
    borderRadius: "0 60px 60px 0", // Rounded shape
    bgcolor: isActive
      ? `linear-gradient(90deg, ${primaryColor} 0%, rgba(255, 255, 255, 0) 100%)`
      : "transparent",
    "&:hover": {
      bgcolor: isActive
        ? `linear-gradient(90deg, ${primaryColor} 0%, rgba(255, 255, 255, 0.2) 100%)`
        : "rgba(0, 0, 0, 0.05)",
    },
